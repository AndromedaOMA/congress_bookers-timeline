...
export function Roadmap() {
  ...
  const data = [
    {
      id: "phase-01",
      title: "Phase 01: The Journey Begins at Your Door",
    ...
    },
    {
      ...
      clientText: "Luggage collected before breakfast. Four phases. One seamless performance. The science was exceptional, and she flies home with memories.",
  ...
  return (
    <section id="process-roadmap">
      {/* Pass the completion callback down to Timeline */}
      <Timeline data={data} onComplete={() => setIsTimelineComplete(true)} />
      
      {/* Conditionally reveal FullCircle with a smooth fade & slide */}
      <AnimatePresence>
        {isTimelineComplete && (
          <motion.div
